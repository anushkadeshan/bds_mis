...
class AwarenessTable extends LivewireDatatable
{

    public $model = AwarnessSGBV::class;
    protected $listners = ['refreshLivewireDatatable' => 'columns'];

    public function builder()
    {
        return AwarnessSGBV::query()->leftJoin('gn_office', 'gn_office.id', 'awarness_sgbvs.gnd_id')->leftJoin('dsd_office', 'dsd_office.id', 'awarness_sgbvs.dsd_id');
    }
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['id'], function ($id) {
                return view('livewire.awareness-table', ['id' => $id]);
            })
        ];
    }

...
class CreateIdeaGeneration extends Component
{
    ...
    public function saveData(){
        $this->validate();
        $attendance_name  = $this->attendance->store('ig_attendance');
        //dd($attendance_name);
        $data = IdeaGeneration::create([
        ...
        foreach ($this->photos as $photo) {
            $photo_name = $photo->store('ig_photos');
            IgPhotos::create([
                'name' => $photo_name,
                'ig_id' => $lastId
            ]);
...
//$this->clearForm();
    ...
    {
        return view('livewire.create-idea-generation');
    }
}

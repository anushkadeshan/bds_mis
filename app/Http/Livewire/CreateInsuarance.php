...
use App\Models\IgPhotos;
use App\Models\Insurance;
use App\Models\InsuranceCSO;
use Livewire\WithFileUploads;
use App\Models\IdeaGeneration;
use App\Models\InsurancePhoto;
use App\Models\ResoursePerson;
use App\Models\LivelihoodFamily;
use App\Models\IG_CSOparticipants;
use Illuminate\Support\Facades\Auth;

class CreateInsuarance extends Component
{
    ...
    public function saveData(){
        $this->validate();
        $attendance_name  = $this->attendance->store('insuarance_attendance');
        //dd($attendance_name);
        ...
        foreach ($this->photos as $photo) {
            $photo_name = $photo->store('insuarance_photos');
            InsurancePhoto::create([
                'name' => $photo_name,
                'i_id' => $lastId
            ]);
        }
        ...
        session()->flash('message', 'Insurance Schema Activity Created Successfully.');
    ...
    {
        return view('livewire.create-insuarance');
    }
}

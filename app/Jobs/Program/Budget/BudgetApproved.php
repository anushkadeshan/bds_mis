...
use App\Models\User;
use App\Notifications\Program\Budget\NotifyBudgetApproved;
...
class BudgetApproved implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if(!empty($managers)){
            foreach($managers as $manager){
                $manager->notify(new NotifyBudgetApproved($this->budget,$message1,$message2));
            }
        }
    }
}

...
class BudgetSentToReview extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject($this->budget->activity_code.'-'.$this->budget->boarder_activity. ' : New Budget Item to Review')
                    ->line($this->message1)
                    ->line($this->message2)

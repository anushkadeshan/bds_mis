...
class NotifyBudgetDisapproved extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject($this->budget->activity_code.'-'.$this->budget->boarder_activity. ' : Budget Item Disapproved')
                    ->line($this->message1)
                    ->line($this->message2)
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'message' => 'Budget Item Disapproved',

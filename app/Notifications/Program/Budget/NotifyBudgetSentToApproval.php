...
class NotifyBudgetSentToApproval extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject($this->budget->activity_code.'-'.$this->budget->boarder_activity. ' : New Budget Item to Approve')
                    ->line($this->message1)
                    ->line($this->message2)
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'message' => 'Budget Item to Approve',

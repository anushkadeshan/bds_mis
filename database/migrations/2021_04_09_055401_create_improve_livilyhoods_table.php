...
class CreateImproveLivilyhoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('improve_livilyhoods', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('improve_livilyhoods');
    }
}

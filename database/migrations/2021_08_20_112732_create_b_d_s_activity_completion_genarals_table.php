...
class CreateBDSActivityCompletionGenaralsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('activity_completion_genarals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('b_d_s_activity_completion_genarals');
    }
}

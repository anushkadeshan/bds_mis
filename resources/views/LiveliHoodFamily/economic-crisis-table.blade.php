...
@section('title', 'Money Order Documents')
    ...
    <div class="content">
        ...
        <div class="card">
            <section class="card-header">
                <div class="mb-2 row">
                    <div class="col-sm-10">
                        <h4>Economic Crisis: Money Order and Money Order Offering Attachements <span class="inline-flex items-center justify-center px-3 py-2 mr-2 text-lg font-bold leading-none text-red-100 bg-red-600 rounded-full">{{$count}}</span>
                        </h4>
                    </div>
                    <div class="col-sm-2">
                        <a href="{{route('economic-crisis')}}"><button
            ...
            <div class="card-body">
                <div class="px-3 content">
                    ...
                    <livewire:moneyorder.economic-crisis-table exportable>
                    @else

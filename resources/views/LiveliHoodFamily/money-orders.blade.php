    ...
    <div class="content">
        ...
        <div class="card">
            <section class="card-header">
                <div class="mb-2 row">
                    <div class="col-sm-9">
                        <h1>Profile Picture and Money Order Offering Attachements <span class="inline-flex items-center justify-center px-3 py-2 mr-2 text-lg font-bold leading-none text-red-100 bg-red-600 rounded-full">{{$count}}</span>
                        </h1>
                    </div>
                    <div class="col-sm-3">
                        <a href="{{route('upload-profile-picture')}}"><button
            ...
            <div class="card-body">
                <div class="px-3 content">
                    ...
                    <livewire:money-orders exportable>
                    @else

...
@section('title', 'Log Frame Activities')
...
<li class="breadcrumb-item active">Log Frame Activities</li>
@endsection
...
<div class="container mt-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="content px-3">
                    ...
                    <livewire:log-frame.activities-table exportable/>
                    @else
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <livewire:log-frame.activities-create>
    </div>
</div>
@endsection

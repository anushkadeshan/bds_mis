    ...
    <section class="min-h-screen flex items-stretch text-white ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                <h1 class="my-6">
                    <img class="w-auto h-7 sm:h-16 inline-flex" src="{{asset('Logo2.jpg')}}" alt="">
                </h1>
                ...
                <div class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        ...
                        <button class="uppercase block w-full p-4 text-white text-lg rounded-full bg-yellow-500 hover:bg-yellow-600 focus:outline-none">sign up</button>
                        </a>
                    </div>
                    <div class="p-4 text-center right-0 left-0 text-white  flex justify-center space-x-4 mt-16 lg:hidden ">
                        <a href="#">

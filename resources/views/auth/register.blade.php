    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
            ...
            <div class="w-full px-24 z-10">
                <img class="w-auto h-40 sm:h-16 inline-flex" src="{{asset('Logo-small.jpg')}}" alt="">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form method="POST" action="{{ route('register') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    @csrf
                    <div class="pb-2 pt-4">
                        <input type="text" name="name" id="name" placeholder="Name" class="block w-full p-3 text-lg rounded-sm bg-black" :value="old('name')" required autofocus autocomplete="name">
                    </div>
                    <div class="pb-2 pt-4">
                        <input :value="old('email')" required type="email" name="email" id="email" placeholder="Email" class="block w-full p-3 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                        <input required autocomplete="new-password"  class="block w-full p-3 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Password">
                    </div>
                    <div class="pb-2 pt-4">
                        <input name="password_confirmation" required autocomplete="new-password"  class="block w-full p-3 text-lg rounded-sm bg-black" type="password" name="password_confirmation" id="password_confirmation" placeholder="Password Confirm">
                    </div>
                    <div class="pb-2 pt-4">
                        <input required class="block w-full p-3 text-lg rounded-sm bg-black" type="text" :value="old('phone')" name="phone" id="phone" placeholder="Phone Number">
                    </div>
                ...
                <div class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <a href="{{url('/')}}">
                        <button class="uppercase block w-full p-4 text-lg rounded-full bg-yellow-500 hover:bg-yellow-600 focus:outline-none">sign in</button>
                        </a>
                    </div>

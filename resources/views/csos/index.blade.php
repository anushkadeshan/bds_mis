...
<li class="breadcrumb-item">CSOs</li>
        ...
        <div class="card">
            <section class="card-header">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-3">
                        <a href="{{route('cso.create')}}"><button
            ...
            <div class="card-body">
                <div class="content px-3">
                    ...
                    <livewire:csos.csos-table/>
                    @else
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        <strong class="font-bold">Opps!</strong>
                        <span class="block sm:inline">You don't have permisision to View CSOs Details</span>
                    </div>
                    @endcan

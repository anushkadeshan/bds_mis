...
<body class="font-sans antialiased hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            Echo.channel('bds_mis')
                .listen('createGn', (e) => {
                    toastr['success'](e.gn.name + ' GN Division Added by ' + e.user.name);

                });

            Echo.channel('bds_mis')
                .listen('CreateDSD', (e) => {
                    toastr['success'](e.dsd.name + ' DS Division Added by ' + e.user.name);
                });
            @hasanyrole('M&E Staff|M&E Manager|Regional Manager|General Manager|Super Admin')
            Echo.channel('bds_mis')
                .listen('CreateNewFamily', (e) => {

                ...
                <div class="border-b-2 py-2">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div class="flex-1">
                            ...
                            <div x-show="step === 5">
                                <div class="text-lg font-bold text-gray-700 leading-tight">Bank Details</div>
                            </div>
                        </div>
                ...
                <div class="py-4">
                    <div x-show.transition.in="step === 1">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="stream" wire:model="stream" id="stream" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                    <option value="">Select a Option</option>
                    ...
                    <div x-show.transition.in="step === 2">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="photo">Student Picture</label>
                                <input wire:model="photo" id="photo" type="file" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('photo') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    <div x-show.transition.in="step === 3">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="client_code">BMIC Client's Name</label>
                                <input wire:model="client_name" id="client_name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('client_name') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="bmic_branch">BMIC Branch</label>
                                <input wire:model="bmic_branch" id="bmic_branch" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('bmic_branch') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="bmic_region">BMIC Region</label>
                                <input wire:model="bmic_region" id="bmic_region" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('bmic_region') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                    ...
                    <div x-show.transition.in="step === 4">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="payment_end_month">Payment Finished Month</label>
                                <select wire:model="payment_end_month" id="payment_end_month" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                    <option value="">Select a Option</option>
                                    <option value="1">January</option>
                                    <option value="2">Febuary</option>
                                    <option value="3">March</option>
                                    ...
                                    <option value="11">November</option>
                                    <option value="12">December</option>
                                </select> @error('payment_end_month') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                    ...
                    <div x-show.transition.in="step === 5">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="bank_name">Bank Name</label>
                                <select wire:model="bank_name" id="bank_name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                                <option value="">Select a Option</option>
                                <option value="People's Bank">People's Bank</option>
                                <option value="Bank of Ceylon">Bank of Ceylon</option>
                            </select> @error('bank_name') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="branch_name">Branch Name</label>
                                <input wire:model="branch_name" id="branch_name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('branch_name') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="branch_code">Branch Code</label>
                                <input wire:model="branch_code" id="branch_code" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('branch_code') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="bank_account_holder">Bank Account Holder</label>
                                <input wire:model="bank_account_holder" id="bank_account_holder" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('bank_account_holder') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="bank_account_number">Bank Account Number</label>
                                <input wire:model="bank_account_number" id="bank_account_number" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">                                @error('bank_account_number') <span class="text-danger">*{{ $message }}</span> @enderror
                            </div>
            ...
            <div class="mx-auto px-4">
                <div class="flex justify-between">
                    ...
                    <div class="w-1/2 text-right">
                        <button x-show="step < 5" @click="step++" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Next <i class="fas fa-step-forward"></i></button>

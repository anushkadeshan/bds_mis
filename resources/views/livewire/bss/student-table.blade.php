...
<div>
    ...
    <div class="flex space-x-1 justify-around">
        {{--
        @can('Update Student')
        <livewire:bss.stream-confirmed :id="$id" >
        @endcan
        --}}
        <a href="{{ route('students.show', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
        ...
        @can('Update Student')
        <a href="{{ route('students.edit', [$id]) }}" target="_blank" class="p-1 text-green-600 hover:bg-green-600 hover:text-white rounded">

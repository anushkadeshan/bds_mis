<div>
    <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Add Log Frame Activity</h5>
            ...
            <div class="modal-body">
                ...
                @endif
                <div class="flex">
                    <span class="text-sm border border-2 w-25 rounded-l px-4 py-2 bg-gray-300 whitespace-no-wrap">Activity Code :</span>
                ...
                <br/>
                <div class="flex">
                    <span class="text-sm border border-2 w-25 rounded-l px-4 py-2 bg-gray-300 whitespace-no-wrap">Activity Name :</span>

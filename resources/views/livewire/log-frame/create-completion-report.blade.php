                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex flex-col w-3/12 px-2">
                                    ...
                                    <input wire:model="beneficiary_meterial.0" type="text" autofocus
                                ...
                                <div class="flex flex-col w-3/12 px-2">
                                    ...
                                    <input wire:model.defer="nic_or_reg_no.0" type="text" autofocus id="nic_or_reg_no"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                            ...
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">Beneficiary/CSO Name</label>
                                    <input wire:model="beneficiary_meterial.{{$value}}" type="text" autofocus
                                        id="beneficiary_meterial"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                    @error('beneficiary_meterial'.$value) <span class="text-danger">*{{ $message
                                        }}</span>
                                    @enderror
                                </div>
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">NIC or CSO Reg No.</label>
                                    <input wire:model.defer="nic_or_reg_no.{{$value}}" type="text" autofocus
                                        id="nic_or_reg_no"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                    @error('nic_or_reg_no'.$value) <span class="text-danger">*{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">Materials Provided</label>
                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex flex-col w-3/12 px-2">
                                    ...
                                    <input wire:model="beneficiary_financial.0" type="text" autofocus
                                ...
                                <div class="flex flex-col w-3/12 px-2">
                                    ...
                                    <input wire:model="beneficiary_financial_nic.0" type="text" autofocus
                            ...
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">Beneficiary</label>
                                    <input wire:model="beneficiary_financial.{{$value}}" type="text" autofocus
                                        id="beneficiary_financial"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                    @error('beneficiary_financial'.$value) <span class="text-danger">*{{ $message
                                        }}</span>
                                    @enderror
                                </div>
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">Beneficiary NIC</label>
                                    <input wire:model="beneficiary_financial_nic.{{$value}}" type="text" autofocus
                                        id="beneficiary_financial_nic"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                    @error('beneficiary_financial_nic'.$value) <span class="text-danger">*{{ $message
                                        }}</span>
                                    @enderror
                                </div>
                                <div class="flex flex-col w-3/12 px-2">
                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between mb-5">
                                ...
                                <div class="flex flex-col w-3/12 px-2">
                                    ...
                                    <input wire:model="cso_reg_no.0" type="text" autofocus id="cso_reg_no"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                            ...
                            <div class="flex items-center justify-between mb-5">
                                <div class="flex flex-col w-4/12 px-2">
                                    <label for="username" class="block text-black">Name of the CSO</label>
                                    <input wire:model="cso_name.{{$value}}" type="text" autofocus
                                        id="beneficiary_financial"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                ...
                                <div class="flex flex-col w-3/12 px-2">
                                    <label for="username" class="block text-black">CSO Reg No.</label>
                                    <input wire:model="cso_reg_no.{{$value}}" type="text" autofocus id="cso_reg_no"
                                        class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                        placeholder="" />
                                    @error('cso_reg_no'.$value) <span class="text-danger">*{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="flex flex-col w-2/12 px-2">
                                    <label for="username" class="block text-black">No of Male</label>

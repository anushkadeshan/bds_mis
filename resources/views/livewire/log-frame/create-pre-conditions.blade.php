<div>
    ...
    <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="flex">
                    <span class="text-sm border border-2 w-25 rounded-l px-4 py-2 bg-gray-300 whitespace-no-wrap">Pre-Condition Title :</span>
                    <input wire:model="pre_condition" class="border border-2 rounded-r px-4 py-2 w-full" type="text" name="name" spellcheck="false" data-ms-editor="true">

                </div>
                @error('pre_condition') <span class="text-danger">*{{ $message }}</span> @enderror
                <br/>
                <div class="flex">
                    <span class="text-sm border border-2 w-25 rounded-l px-4 py-2 bg-gray-300 whitespace-no-wrap">Project :</span>
                    <select wire:model="project" class="border border-2 rounded-r px-4 py-2 w-full" >

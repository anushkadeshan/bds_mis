<div>
    <div class="flex space-x-1 justify-around">
        @can('View BDS CR')
        <a href="{{ route('marketing-linkages.show', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
        ...
        @endcan
        @can('Update BDS CR')
        <a href="{{ route('marketing-linkages.edit', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">

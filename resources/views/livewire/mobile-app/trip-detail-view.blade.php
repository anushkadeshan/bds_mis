<div class="row mt-10">
    ...
    <div class="col-xl-4 float-right pt-10 pb-10">
                        ...
                        <tr style="border-top: 1pt solid #606060;">
                            ...
                            <td style="border-color:#606060">
                                    ...
                                    <div class="row border border-white">
                                        <div class="col-md-1 bg-blue-700">
                                            {{$no++}}.
                                        </div>
                                        <div class="col-md-2  text-right bg-blue-600 ">
                                            {{$td->trip_start_location}}
                                        </div>
                                        <div class="col-md-2  text-right bg-blue-600">
                                            {{$td->trip_end_location}}
                                        </div>
                                        <div class="col-md-2 text-right bg-blue-500">
                                            {{$td->end_meter_reading-$td->start_meter_reading}}KM
                                        </div>
                                        <div class="col-md-2 bg-blue-400 text-right">
                                            @php
                                            $user_id = $td->user_id;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2  text-right ">
                                        @php
                                            ...
                                            $hoursAndMinutes = intdiv($hoursWithMinutes, 60).'h '. ($hoursWithMinutes % 60).'m';
                                        @endphp

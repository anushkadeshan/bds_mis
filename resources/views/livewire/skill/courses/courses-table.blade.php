<div>
    <div class="flex space-x-1 justify-around">
        <a href="{{ route('courses.show', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
        ...
        <a  href="{{ route('courses.edit', [$id]) }}" target="_blank"  class="p-1 text-green-600 hover:bg-green-600 hover:text-white rounded">

<div>
    <div class="flex space-x-1 justify-around">
        <a href="{{ route('institutes.show', [$id]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-blue-600 hover:text-white rounded">
        ...
        <a  href="{{ route('institutes.edit', [$id]) }}" target="_blank"  class="p-1 text-green-600 hover:bg-green-600 hover:text-white rounded">

<div class="grid gap-6 sm:grid-cols-1 teal-100 p-2">
    <div class="relative">
        ...
        <ul class="bg-white border border-gray-100 w-full mt-2 ">
            ...
            <li wire:click.prevent="selectStudent({{$family['id']}})" class="pl-8 pr-2 py-1 border-b-2 border-gray-100 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900">
                <b>{{$family['head_of_household']}}</b>
            </li>
            @endforeach
        </ul>
        @endif

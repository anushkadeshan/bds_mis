            ...
            <div class="text-sm text-gray-700">
                <div class="grid justify-between grid-cols-3 gap-4">
                    <div class="border-gray-500 border-dotted  bg-grey-lighter">
                        <label class="flex flex-col items-center px-4 py-6 m-3 tracking-wide bg-white border rounded-lg shadow-lg cursor-pointer w-80 text-blue border-blue hover:bg-blue hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                            </svg>
                            <span class="mt-2 text-base leading-normal uppercase">Select Profile Picture</span>
                            <span class="mt-2 text-sm text-red ">*photo should be 100px * 100px</span>
                        ...
                        <div class="px-4">
                            ...
                            @endif
                            <button wire:click.prevent="saveProfilePhoto" class="inline-flex items-center px-4 py-2 font-bold text-white bg-green-700 rounded hover:bg-green-600">
                                <svg wire:loading wire:target="saveProfilePhoto" class="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">

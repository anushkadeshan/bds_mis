    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="flex">
                    <span class="px-4 py-2 text-sm whitespace-no-wrap bg-gray-300 border border-2 rounded-l w-25">Output
                        :</span>
                    <input wire:model="output" class="w-full px-4 py-2 border border-2 rounded-r" type="text"
                ...
                <div class="flex">
                    <span
                        class="px-4 py-2 text-sm whitespace-no-wrap bg-gray-300 border border-2 rounded-l w-25">Outcome
                        :</span>
                    <select wire:model="outcome_id" class="w-full px-4 py-2 border border-2 rounded-r">
                        <option value="">Select Option</option>
                        @foreach($outcomes as $o)
                        <option value="{{$o->id}}">{{$o->outcome}}</option>
                        @endforeach

<div>
    <div class="container-fluid">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    @elseif($t->action == 'Disapproved' || $t->action == 'Review Failed')
        ...
        <div  data-bs-toggle="modal" data-bs-target="#searchId " class="absolute w-14 h-14 opacity-25 hover:opacity-90 bg-gray-900 z-50 rounded-full position-fixed top-96 right-4 text-white text-center d-flex align-items-center justify-content-center">
            ...
            <div class="col-sm-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="flex items-center justify-between mb-5">
                                ...
                                <div class="flex flex-col w-6/12 px-2">
                                    <label for="totol_planned_cost" class="block text-black">Unit Cost</label>
                        ...
                        <div class="tabbed-card">
                            ...
                            <div class="p-0 tab-content" id="pills-clrtabContentsuccess">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="deletePartnerId({{ $p->id }})"
                                ...
                                <div class="tab-pane fade" id="pills-clrprofilesuccess" role="tabpanel"
                                    ...
                                    <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="addPartner" class="mt-4 btn btn-primary">Add
                                        Partner</button>
                                </div>
                            </div>
                        ...
                        <div class="tabbed-card">
                            ...
                            <div class="p-0 tab-content" id="pills-clrtabContentsuccess">
                                ...
                                <div class="tab-pane fade" id="pills-clrprofilesuccess2" role="tabpanel"
                                    ...
                                    <button {{$isDraft ? '' : 'disabled' }} type="button" class="mt-2 btn btn-primary"
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="updateConstruction"
                            class="btn btn-success mt-4 ml-2" >Update Construction Data</button>
                    </div>
                                ...
                                <div class="p-0 tab-pane fade active show" id="pills-clrhomesuccess4" role="tabpanel"
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$p->beneficiary->hh_name}}</td>
                                                <td>{{ !empty($p->cso) ? $p->cso->name : 'N/A'}}</td>
                                                <td>{{$p->meterial_provided}}</td>
                                                <td>{{$p->meterial_quantity}}</td>
                                                <td>
                                                    <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="deleteMaterialId({{ $p->id }})"
                                                        class="btn btn-danger" data-toggle="modal"
                                                        data-target="#exampleModal">Delete</button>
                                                </td>
                                            </tr>
                                ...
                                <div class="tab-pane fade" id="pills-clrprofilesuccess4" role="tabpanel"
                                    ...
                                    <div  class="flex items-center justify-between mb-5">
                                        ...
                                        <div class="flex flex-col w-4/12 px-2">
                                            ...
                                            <input wire:model="beneficiary_id" type="number" autofocus
                                                id="beneficiary_id"
                                        ...
                                        <div class="flex flex-col w-4/12 px-2">
                                            ...
                                            <input wire:model.defer="cso_id" type="text" autofocus id="nic_or_reg_no"
                                                class="w-full px-3 py-2 mt-1 bg-gray-100 rounded-sm focus:outline-none"
                                                placeholder="" />
                                    ...
                                    <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="addmaterialsupports"
                        ...
                        <div class="tabbed-card">
                            ...
                            <div class="p-0 tab-content" id="pills-clrtabContentsuccess">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button {{$isDraft ? '' : 'disabled' }}  type="button" wire:click="deleteFiancialId({{ $p->id }})"
                                                        class="btn btn-danger" data-toggle="modal"
                                                        data-target="#exampleModal">Delete</button>
                                                </td>
                                            </tr>
                                ...
                                <div class="tab-pane fade" id="pills-clrprofilesuccess5" role="tabpanel"
                                    ...
                                    <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="addFinancialsupports"
                                        class="mt-4 btn btn-primary">Add
                                ...
                                <div class="p-0 tab-content" id="pills-clrtabContentsuccess">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$p->cso_female}}</td>
                                                    <td>
                                                        <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="deleteCsoId({{ $p->id }})"
                                                            class="btn btn-danger" data-toggle="modal"
                                                            data-target="#exampleModal">Delete</button>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="tab-pane fade" id="pills-clrprofilesuccess3" role="tabpanel"
                                        ...
                                        <div class="flex items-center justify-between mb-5">
                                            <div class="flex flex-col w-4/12 px-2">
                                                <label for="username" class="block text-black">CSO ID</label>
                                                <input wire:model.defer="selected_cso_id" type="text" autofocus
                                                    id="beneficiary_financial"
                                                    class="w-full px-3 py-2 mt-2 bg-gray-100 rounded-sm focus:outline-none"
                                                    placeholder="" />
                                                @error('selected_cso_id') <span class="text-danger">*{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="addCso" class="mt-4 btn btn-primary">Add
                                            CSO Data</button>
                                    </div>
                                </div>
                    ...
                    <div class="mt-20 col-sm-12 col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <button {{$isDraft ? '' : 'disabled' }} type="button" wire:click="updateTraningData" class="mt-4 btn btn-primary">Update
                ...
                <div class="mt-20 col-sm-12 col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="{{URL::asset('storage/'.$attachment->file_name)}}">{{$attachment->file_name}}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
                @if($isDraft)
                    @can('Create BDS CR')
                    <button type="button" wire:click="sendtoReview" class="mt-2 btn btn-primary">Send to Review</button>
                    @endcan
                @else
                    @if(!$isReviewed)
                        @can('Review BDS CR')
                            <button type="button" wire:click="sendtoApproval" class="mt-2 btn btn-primary">Send to Approval</button>
                            <button type="button" wire:click="doRereview" class="mt-2 btn btn-danger">Fail</button>
                        @endcan
                    @else
                        @can('Approve BDS CR')
                            <button {{$isApproved ? 'disabled' : '' }} type="button" wire:click="Approved" class="mt-2 btn btn-success">Approve</button>
                            <button {{$isApproved ? 'disabled' : '' }} type="button" wire:click="disApprove" class="mt-2 btn btn-danger">Disapprove</button>
                        @endcan
                    @endif
                @endif
            </div>

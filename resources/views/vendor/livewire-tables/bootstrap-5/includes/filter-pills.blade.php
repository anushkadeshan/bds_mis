<div>
    ...
    <div class="mb-3">
        ...
        <span wire:key="filter-pill-{{ $key }}" class="p-2 badge rounded-pill bg-info d-inline-flex align-items-center">
        ...
        <a href="#" wire:click.prevent="resetFilters"
            class="p-2 text-white badge rounded-pill bg-danger text-decoration-none">
            @lang('Clear')
        </a>
    </div>
    @endif

<div wire:click.prefetch="toggle('{{ $index }}')"
    ...
    <button class="relative h-12 w-3 focus:outline-none">
        <span
            class="w-32 hidden group-hover:inline-block absolute z-100 top-0 left-0 ml-3 bg-blue-300 font-medium leading-4 text-xs text-left text-black-700 tracking-wider transform uppercase focus:outline-none">
